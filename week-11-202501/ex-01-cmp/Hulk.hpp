...
public:
	...
	bool estaColisionando(Rectangle objeto);
	bool estaColisionandoTolerancia(Rectangle objeto, float tolHorizontal, float tolVertical);
};
...
bool Hulk::estaColisionando(Rectangle objeto)
{
	return objeto.IntersectsWith(Rectangle(x, y, width * zoom, height * zoom));
}

bool Hulk::estaColisionandoTolerancia(Rectangle objeto, float tolHorizontal, float tolVertical)
{
	return objeto.IntersectsWith(Rectangle(x + tolHorizontal, y + tolVertical, width * zoom - tolHorizontal, height * zoom - tolVertical));;
}
